...
def _wrapped_func(func_and_args):
    func, argument, should_print_progress, filter_, all_remarks = func_and_args
    ...
    return func(argument, filter_, all_remarks)


def pmap(func, iterable, processes, should_print_progress, filter_=None, all_remarks=False, *args, **kwargs):
    """
    ...
    func_and_args = [(func, arg, should_print_progress, filter_, all_remarks) for arg in iterable]
    if processes == 1:
